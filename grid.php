...
function _draw_grid(&$TWorkstation, $column_width) {
	...
	foreach($TWorkstation as $w_id=>&$w_param) {
		...
		?><div id="columm-ws-<?php echo $w_id; ?>" valign="top" style="float:left;margin-right: 5px; width:<?php echo round($w_column); ?>px; <?php echo $back; ?> border:1px solid #666;">
				...
				<ul style="position:relative;min-height: 500px;min-width:<?php echo round($w_column); ?>" id="list-task-<?php echo $w_id; ?>" ws-id="<?php echo $w_id; ?>" class="task-list droppable connectedSortable needToResize" rel="all-task" ws-nb-ressource="<?php echo $w_param['nb_ressource']; ?>">
